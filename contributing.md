...
Contributions are accepted via Pull Requests on [Github](https://github.com/sjshovan/laravel-ruleset-validation).
...
- **Send coherent history** - Make sure each commit in your pull request is meaningful. If you had to make
